...
with open("sample_rag_doc.txt", "r", encoding="utf-8") as file:
...
queries = [
    "How many stars and forks are there for the provided repository?",
    "List the names of some of the contributors to the given repository."
]
